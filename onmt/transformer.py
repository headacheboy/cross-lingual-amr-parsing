...
class JointModel(nn.Module):
  ...
  def forward(self, src, tgt, lengths, task_type):
...
def build_embeddings_2(emb_dim, padding_idx, num_word, opt):
...
def load_test_model(opt, dummy_opt, model_path=None, use_softmax=True, get_model_opt=False, init=False):
...
def build_base_model(model_opt, fields, gpu, checkpoint=None, use_softmax=True):
  """
  Args:
